...
GLOBAL_LIST_INIT(thumper_stall_descriptions, list(
	THUMPER_STALL_LOCATION = "an unsuitable location",
...
/obj/machinery/power/colony_ore_thumper/examine(mob/user)
	...
	. += span_notice("Its status lamp glows <b>green</b> when operating normally, flashes <b>yellow</b> when ready to operate but prevented by external conditions, and <b>red</b> when switched off.")
